...
// clientSecret must come from the environment — never committed (used server-side
// only, in the token-exchange flow). Set ANTIGRAVITY_OAUTH_CLIENT_SECRET to enable.
